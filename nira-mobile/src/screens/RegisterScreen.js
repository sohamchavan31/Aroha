...
export default function RegisterScreen({ navigation }) {
  ...
  async function handleRegister() {
    ...
    try {
      ...
      await login(data.token, { name: data.name, rank: data.rank, totalXp: data.totalXp });
    } catch (err) {
        ...
        >
          ...
          <View style={styles.header}>
            <View style={styles.rankBadge}>
              <Text style={styles.rankLabel}>NEW HUNTER</Text>
            </View>
            <Text style={styles.title}>Nira</Text>
            <Text style={styles.subtitle}>Begin Your Awakening</Text>
          </View>
